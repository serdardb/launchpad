(function ($) {
  ...
  */
  ...
  /*function modeSwitcher() {
    ...
    function modeSwitcher() {
        // Checkbox'ın durumunu local storage'dan yükleyin ve ayarlayın
        const darkMode = localStorage.getItem('darkMode') === 'true';
        $('#mode_switch').prop('checked', darkMode).change();

        // Checkbox değiştiğinde tetiklenecek fonksiyon
        $("#mode_switch").change(function() {
            const isDarkMode = this.checked;
            $("body").toggleClass("cs-dark", isDarkMode);

            // Yeni durumu local storage'a kaydedin
    ...
    // Local storage'dan dark mode durumunu kontrol edin ve uygulayın
    const darkMode = localStorage.getItem('darkMode') === 'true';
    if (darkMode) {
        $("body").addClass("cs-dark");
    }
